...
using BitirmeÖdevi_CarReservation.Application.Features.CQRS.Queries.CategoryQueries;
...
namespace BitirmeÖdevi_CarReservation.WebApi.Controllers
{
    ...
    public class CategoriesController : ControllerBase
    {
        ...
        public async Task<IActionResult> CreateCategory(CreateCategoryCommand command)
        {
            ...
            return Ok("Katagori bilgisi başarılı bir şekilde eklendi.");
        }
        ...
        public async Task<IActionResult> RemoveCategory(int id)
        {
            ...
            return Ok("Katagori bilgisi başarılı bir şekilde silindi.");
        }
        ...
        public async Task<IActionResult> UpdateCategory(UpdateCategoryCommand command)
        {
            ...
            return Ok("Katagori bilgisi başarılı bir şekilde güncellendi.");
        }
    }
}
