...
namespace CarBook.ViewModel.ViewModels.StatisticsViewModels
{
    public class ResultStatisticViewModel
    {
        ...
        public string CarCountByKmBiggerThen30000 { get; set; }
        public int FiveSeatCarCount { get; set; }
        public int LargeLuggageCarCount { get; set; }
    }
}
